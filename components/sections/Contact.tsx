        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
          ...
          >
            ...
            <p className="text-sm text-text-muted">
              Fastest way to discuss opportunities
            </p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-text-muted">
              Quick questions? Reply within 1 hour
            </p>
          </a>
          ...
          <div className="card text-center">
            ...
            <p className="text-sm text-text-muted">
              Formal inquiries: use form below
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="w-full px-4 py-3 bg-surface border-2 border-border rounded-lg focus:border-primary focus:outline-none text-text"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-4 py-3 bg-surface border-2 border-border rounded-lg focus:border-primary focus:outline-none text-text resize-none"
                placeholder="Tell me about your data challenge — e.g., 'We need a real-time ETL pipeline for fraud detection' or 'I’m looking for a RAG engineer to build an internal knowledge assistant.'"
              ></textarea>
            </div>
            ...
            {formStatus === 'error' && (
              <p className="text-red-600 text-sm">
                Failed. Please email rosewabere1@gmail.com directly.
              </p>
            )}
          </form>
        </div>
